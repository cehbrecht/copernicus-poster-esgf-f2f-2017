...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{C3S MAGIC}{name=magic,column=1,span=2,below=cp4cds}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{multicols}{2}
  Goal of the project
  ...
  \begin{itemize}\compresslist
    \item to calculte standardized characteristics
  ...
  \begin{minipage}{0.2\textwidth}
    \includegraphics[width=0.5\linewidth]{taylor}
  \end{minipage}
  ...
  \begin{minipage}{0.2\textwidth}
    \includegraphics[width=0.5\linewidth]{model-robustness}
  \end{minipage}
  \begin{minipage}{0.8\textwidth}
  ...
  \begin{minipage}{0.2\textwidth}
    \includegraphics[width=0.5\linewidth]{predefined-indices}
  \end{minipage}
  \begin{minipage}{0.8\textwidth}
  ...
  \begin{minipage}{0.2\textwidth}
    \includegraphics[width=0.5\linewidth]{stochastic-downscaling}
  \end{minipage}
  \begin{minipage}{0.8\textwidth}
    Tailored products:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Architecture}{name=arch,column=1,span=2,below=magic}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{minipage}{0.3\textwidth}
