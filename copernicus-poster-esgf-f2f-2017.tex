...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   \begin{minipage}[t]{0.5\textwidth}
     \includegraphics[width=0.6\linewidth]{cp4cds}
     \begin{itemize}\compresslist
       ...
       \item Climate Projections in filesystem cache - selected for C3S and quality checked
       \item \emph{Synda} Python library for managing data movement (replication)
     \end{itemize}
  \end{minipage}
  \begin{minipage}[t]{0.25\textwidth}
    \includegraphics[width=\linewidth]{cp4cds-federated}
    \begin{itemize}\compresslist
