...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \begin{minipage}{0.3\textwidth}
  ...
  \end{minipage}
  \begin{minipage}{0.7\textwidth}
    Federated between CEDA, IPSL and DKRZ
    \begin{itemize}\compresslist
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{minipage}{0.7\textwidth}
    ...
    \begin{itemize}\compresslist
      \item Used by CP4CDS as \emph{Processing Backend} for CMIP5 climate model projections
      ...
      \item \emph{ESMValTool} - To develop and deliver an enhanced version of the ESMValTool software
